...
public class DeepStoneOreBlock extends CarnelianModElements.ModElement {
	@ObjectHolder("carnelian:deep_stone_ore")
	public static final Block block = null;
	public DeepStoneOreBlock(CarnelianModElements instance) {
		super(instance, 70);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("carnelian:deep_stone_ore_match"), () -> CustomRuleTest.codec);
			...
			configuredFeature = feature.withConfiguration(new OreFeatureConfig(CustomRuleTest.INSTANCE, block.getDefaultState(), 10)).range(24)
					.square().func_242731_b(4);
			event.getRegistry().register(feature.setRegistryName("deep_stone_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("carnelian:deep_stone_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
