...
import net.mcreator.carnelian.procedures.DeepStoneOreBlockDestroyedByPlayerProcedure;
...
public class DeepStoneOreBlock extends CarnelianModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				DeepStoneOreBlockDestroyedByPlayerProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		}, block.getDefaultState(), 10)).range(24).square().func_242731_b(4));
	}
}
