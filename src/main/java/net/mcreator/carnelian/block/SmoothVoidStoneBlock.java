...
import net.mcreator.carnelian.procedures.SmoothVoidStoneBlockDestroyedByPlayerProcedure;
...
public class SmoothVoidStoneBlock extends CarnelianModElements.ModElement {
	@ObjectHolder("carnelian:smooth_void_stone")
	public static final Block block = null;
	public SmoothVoidStoneBlock(CarnelianModElements instance) {
		super(instance, 88);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("smooth_void_stone");
		}
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				SmoothVoidStoneBlockDestroyedByPlayerProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
