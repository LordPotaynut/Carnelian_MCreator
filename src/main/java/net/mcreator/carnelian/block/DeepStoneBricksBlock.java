...
import net.mcreator.carnelian.procedures.DeepStoneBricksBlockDestroyedByPlayerProcedure;
...
public class DeepStoneBricksBlock extends CarnelianModElements.ModElement {
	@ObjectHolder("carnelian:deep_stone_bricks")
	public static final Block block = null;
	public DeepStoneBricksBlock(CarnelianModElements instance) {
		super(instance, 76);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("deep_stone_bricks");
		}
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				DeepStoneBricksBlockDestroyedByPlayerProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
