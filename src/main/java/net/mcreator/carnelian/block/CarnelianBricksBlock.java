...
import net.mcreator.carnelian.procedures.CarnelianBricksBlockDestroyedByPlayerProcedure;
...
public class CarnelianBricksBlock extends CarnelianModElements.ModElement {
	@ObjectHolder("carnelian:carnelian_bricks")
	public static final Block block = null;
	public CarnelianBricksBlock(CarnelianModElements instance) {
		super(instance, 74);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("carnelian_bricks");
		}
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				CarnelianBricksBlockDestroyedByPlayerProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
