...
import net.mcreator.carnelian.procedures.SmoothDeepStoneBlockDestroyedByPlayerProcedure;
...
public class SmoothDeepStoneBlock extends CarnelianModElements.ModElement {
	@ObjectHolder("carnelian:smooth_deep_stone")
	public static final Block block = null;
	public SmoothDeepStoneBlock(CarnelianModElements instance) {
		super(instance, 84);
	}
	...
	public static class CustomBlock extends Block {
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				SmoothDeepStoneBlockDestroyedByPlayerProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
