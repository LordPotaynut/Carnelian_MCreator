...
public class SmoothVoidStoneSlabBlock extends CarnelianModElements.ModElement {
	@ObjectHolder("carnelian:smooth_void_stone_slab")
	public static final Block block = null;
	public SmoothVoidStoneSlabBlock(CarnelianModElements instance) {
		super(instance, 93);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("smooth_void_stone_slab");
		}
