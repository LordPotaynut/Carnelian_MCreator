...
public class SmoothCarnelianStoneSlabBlock extends CarnelianModElements.ModElement {
	@ObjectHolder("carnelian:smooth_carnelian_stone_slab")
	public static final Block block = null;
	public SmoothCarnelianStoneSlabBlock(CarnelianModElements instance) {
		super(instance, 90);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("smooth_carnelian_stone_slab");
		}
