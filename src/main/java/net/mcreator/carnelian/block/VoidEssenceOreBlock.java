...
import net.mcreator.carnelian.procedures.VoidEssenceOreBlockDestroyedByPlayerProcedure;
...
public class VoidEssenceOreBlock extends CarnelianModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(4f, 9f).setLightLevel(s -> 0).harvestLevel(2)
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				VoidEssenceOreBlockDestroyedByPlayerProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		}, block.getDefaultState(), 16)).range(255).square().func_242731_b(3));
	}
}
