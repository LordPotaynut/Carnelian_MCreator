...
public class DeepStoneBrickSlabBlock extends CarnelianModElements.ModElement {
	@ObjectHolder("carnelian:deep_stone_brick_slab")
	public static final Block block = null;
	public DeepStoneBrickSlabBlock(CarnelianModElements instance) {
		super(instance, 103);
	}
