...
public class IronPlatingBlock extends CarnelianModElements.ModElement {
	@ObjectHolder("carnelian:iron_plating")
	public static final Block block = null;
	public IronPlatingBlock(CarnelianModElements instance) {
		super(instance, 179);
	}
