...
public class CarnelianOreBlock extends CarnelianModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("carnelian:carnelian_ore_match"), () -> CustomRuleTest.codec);
			...
			configuredFeature = feature.withConfiguration(new OreFeatureConfig(CustomRuleTest.INSTANCE, block.getDefaultState(), 8)).range(32)
					.square().func_242731_b(2);
			event.getRegistry().register(feature.setRegistryName("carnelian_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("carnelian:carnelian_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
