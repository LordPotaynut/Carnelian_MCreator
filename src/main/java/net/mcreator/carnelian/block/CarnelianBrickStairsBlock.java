...
public class CarnelianBrickStairsBlock extends CarnelianModElements.ModElement {
	@ObjectHolder("carnelian:carnelian_brick_stairs")
	public static final Block block = null;
	public CarnelianBrickStairsBlock(CarnelianModElements instance) {
		super(instance, 94);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("carnelian_brick_stairs");
		}
