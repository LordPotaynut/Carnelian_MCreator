...
public class IronGrateFenceBlock extends CarnelianModElements.ModElement {
	@ObjectHolder("carnelian:iron_grate_fence")
	public static final Block block = null;
	public IronGrateFenceBlock(CarnelianModElements instance) {
		super(instance, 194);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("iron_grate_fence");
		}
