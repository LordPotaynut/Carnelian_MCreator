...
import net.mcreator.carnelian.procedures.OvergrowthBricksBlockDestroyedByPlayerProcedure;
...
public class OvergrowthBricksBlock extends CarnelianModElements.ModElement {
	@ObjectHolder("carnelian:overgrowth_bricks")
	public static final Block block = null;
	public OvergrowthBricksBlock(CarnelianModElements instance) {
		super(instance, 78);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("overgrowth_bricks");
		}
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				OvergrowthBricksBlockDestroyedByPlayerProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
