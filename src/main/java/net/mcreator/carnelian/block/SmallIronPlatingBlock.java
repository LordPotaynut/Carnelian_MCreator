...
public class SmallIronPlatingBlock extends CarnelianModElements.ModElement {
	@ObjectHolder("carnelian:small_iron_plating")
	public static final Block block = null;
	public SmallIronPlatingBlock(CarnelianModElements instance) {
		super(instance, 189);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("small_iron_plating");
		}
