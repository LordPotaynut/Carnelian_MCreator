...
import net.mcreator.carnelian.procedures.VoidBrickStairsBlockDestroyedByPlayerProcedure;
	...
	public static class CustomBlock extends StairsBlock {
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				VoidBrickStairsBlockDestroyedByPlayerProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
