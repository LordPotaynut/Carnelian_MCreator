...
public class SmoothDeepStoneSlabBlock extends CarnelianModElements.ModElement {
	@ObjectHolder("carnelian:smooth_deep_stone_slab")
	public static final Block block = null;
	public SmoothDeepStoneSlabBlock(CarnelianModElements instance) {
		super(instance, 91);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("smooth_deep_stone_slab");
		}
