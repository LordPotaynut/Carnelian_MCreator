...
public class OvergrowthBrickSlabBlock extends CarnelianModElements.ModElement {
	@ObjectHolder("carnelian:overgrowth_brick_slab")
	public static final Block block = null;
	public OvergrowthBrickSlabBlock(CarnelianModElements instance) {
		super(instance, 104);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("overgrowth_brick_slab");
		}
