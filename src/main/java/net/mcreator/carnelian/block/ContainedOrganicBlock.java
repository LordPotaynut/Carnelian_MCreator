...
import net.mcreator.carnelian.procedures.ActiveOvergrowthTickedProcedure;
...
public class ContainedOrganicBlock extends CarnelianModElements.ModElement {
	@ObjectHolder("carnelian:contained_organic")
	public static final Block block = null;
	public ContainedOrganicBlock(CarnelianModElements instance) {
		super(instance, 178);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				ActiveOvergrowthTickedProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
