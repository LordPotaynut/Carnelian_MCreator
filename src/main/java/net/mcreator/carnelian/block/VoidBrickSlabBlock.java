...
public class VoidBrickSlabBlock extends CarnelianModElements.ModElement {
	@ObjectHolder("carnelian:void_brick_slab")
	public static final Block block = null;
	public VoidBrickSlabBlock(CarnelianModElements instance) {
		super(instance, 105);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("void_brick_slab");
		}
