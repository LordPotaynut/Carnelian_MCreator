...
import net.mcreator.carnelian.procedures.DeepStoneBrickStairsBlockDestroyedByPlayerProcedure;
	...
	public static class CustomBlock extends StairsBlock {
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				DeepStoneBrickStairsBlockDestroyedByPlayerProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
