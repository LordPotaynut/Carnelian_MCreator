...
public class SmoothOvergrowthStoneSlabBlock extends CarnelianModElements.ModElement {
	@ObjectHolder("carnelian:smooth_overgrowth_stone_slab")
	public static final Block block = null;
	public SmoothOvergrowthStoneSlabBlock(CarnelianModElements instance) {
		super(instance, 92);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("smooth_overgrowth_stone_slab");
		}
