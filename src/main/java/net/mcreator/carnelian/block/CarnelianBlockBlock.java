...
public class CarnelianBlockBlock extends CarnelianModElements.ModElement {
	@ObjectHolder("carnelian:carnelian_block")
	public static final Block block = null;
	public CarnelianBlockBlock(CarnelianModElements instance) {
		super(instance, 22);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("carnelian_block");
		}
