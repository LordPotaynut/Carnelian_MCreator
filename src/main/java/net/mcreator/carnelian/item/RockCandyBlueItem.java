...
public class RockCandyBlueItem extends CarnelianModElements.ModElement {
	@ObjectHolder("carnelian:rock_candy_blue")
	public static final Item block = null;
	public RockCandyBlueItem(CarnelianModElements instance) {
		super(instance, 3);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			...
			setRegistryName("rock_candy_blue");
		}
