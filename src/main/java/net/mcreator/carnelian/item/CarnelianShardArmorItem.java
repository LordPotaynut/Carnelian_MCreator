...
public class CarnelianShardArmorItem extends CarnelianModElements.ModElement {
	@ObjectHolder("carnelian:carnelian_shard_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("carnelian:carnelian_shard_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("carnelian:carnelian_shard_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("carnelian:carnelian_shard_armor_boots")
	public static final Item boots = null;
	public CarnelianShardArmorItem(CarnelianModElements instance) {
		super(instance, 161);
	}
