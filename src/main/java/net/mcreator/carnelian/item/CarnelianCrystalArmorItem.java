...
public class CarnelianCrystalArmorItem extends CarnelianModElements.ModElement {
	@ObjectHolder("carnelian:carnelian_crystal_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("carnelian:carnelian_crystal_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("carnelian:carnelian_crystal_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("carnelian:carnelian_crystal_armor_boots")
	public static final Item boots = null;
	public CarnelianCrystalArmorItem(CarnelianModElements instance) {
		super(instance, 162);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(new ItemStack(CarnelianCrystalItem.block, (int) (1)));
			}

			@OnlyIn(Dist.CLIENT)
			@Override
			public String getName() {
				return "carnelian_crystal_armor";
			}
